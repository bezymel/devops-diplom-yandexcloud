...
1. Репозиторий с конфигурацией [ansible](https://github.com/bezymel/kubespray), если был выбран способ создания Kubernetes кластера при помощи ansible.
2. Репозиторий с [Dockerfile](https://github.com/bezymel/nginx-static) тестового приложения и ссылка на собранный docker image.
3. Репозиторий с конфигурацией Kubernetes кластера (в моем случае конфигурация кластера задана в репозитории с kubespray в файле [inventory.ini](https://github.com/bezymel/devops-diplom-yandexcloud/blob/main/ansible-kubespray/inventory.ini) ).
